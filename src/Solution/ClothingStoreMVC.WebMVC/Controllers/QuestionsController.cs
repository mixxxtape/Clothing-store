...
namespace ClothingStoreMVC.WebMVC.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public QuestionsController(ClothingStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var clothingStoreContext = _context.Questions.Include(q => q.Quiz);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Text,QuizId,Id")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
