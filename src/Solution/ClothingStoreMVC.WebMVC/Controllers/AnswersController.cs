...
namespace ClothingStoreMVC.WebMVC.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public AnswersController(ClothingStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var clothingStoreContext = _context.Answers.Include(a => a.Question);
        ...
        public async Task<IActionResult> Create([Bind("Text,QuestionId,Id")] Answer answer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Text,QuestionId,Id")] Answer answer)
        {
            if (id != answer.Id)
            {
                return NotFound();
