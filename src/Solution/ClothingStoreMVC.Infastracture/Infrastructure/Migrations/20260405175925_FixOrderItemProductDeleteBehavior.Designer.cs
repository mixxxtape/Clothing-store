...
namespace ClothingStoreMVC.Infrastructure.Infrastructure.Migrations
{
    ...
    [Migration("20260405175925_FixOrderItemProductDeleteBehavior")]
    partial class FixOrderItemProductDeleteBehavior
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClothingStoreMVC.Domain.Entities.QuizAggregates.Quiz", b =>
                {
                    ...
                    b.ToTable("Quizzes", "Store");
                });

            modelBuilder.Entity("ClothingStoreMVC.Domain.Entities.QuizAggregates.Result", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ClothingStoreMVC.Domain.Entities.UserAggregates.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProductWishlist", b =>
                {
                    ...
                    b.ToTable("ProductWishlist", "Store");
                });
            ...
            modelBuilder.Entity("ClothingStoreMVC.Domain.Entities.QuizAggregates.Question", b =>
                {
                    b.HasOne("ClothingStoreMVC.Domain.Entities.QuizAggregates.Quiz", "Quiz")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("ClothingStoreMVC.Domain.Entities.UserAggregates.CartItem", b =>
                {
                    b.HasOne("ClothingStoreMVC.Domain.Entities.UserAggregates.Cart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("ClothingStoreMVC.Domain.Entities.UserAggregates.User", b =>
                {
                    b.HasOne("ClothingStoreMVC.Domain.Entities.UserAggregates.Role", "Role")
                        .WithMany("Users")
